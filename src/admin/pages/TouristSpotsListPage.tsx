    ...
    },
    {
      ...
      accessor: (r: TouristSpotResponse): ReactNode => (
        <div className="adm-table__actions">
          <button className="adm-btn adm-btn--ghost adm-btn--sm" onClick={() => navigate(`/admin/tourist-spots/${r.id}/edit`)}>✏️</button>
  ...
  return (
    <div>
      <div className="adm-page-header">
        ...
        <button className="adm-btn adm-btn--primary" onClick={() => navigate('/admin/tourist-spots/new')}>+ Novo Ponto</button>
      </div>
      <div className="adm-card">
        <div className="adm-search"><span className="adm-search__icon">🔍</span>
